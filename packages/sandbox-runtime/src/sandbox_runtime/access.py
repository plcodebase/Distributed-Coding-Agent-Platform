"""Shared access policy for paths exposed to coding tools."""
...
def normalize_workspace_path(value: str) -> PurePosixPath:
    """Validate and normalize one model-supplied relative workspace path."""
...
__all__ = ["WorkspaceAccessPolicy", "normalize_workspace_path"]
